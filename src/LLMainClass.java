  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (dtype.equals("VEC")) {
        ...
        for (int i = 0; i < ridx_list.length; i++) {
          System.out.println("ridx_list " + ridx_list[i]);
        }
        ...
        for (int ridx : ridx_list) {
          ...
          for (int i = 0; i < one_row_cidx_list.length; ++i) {
            System.out.println(
                "RIDX " + ridx + " CIDX " + one_row_cidx_list[i] + " VAL " + one_row_vals_list[i]);
          }
        }
        ...
        System.out.println(
            "The first argument has to be either VEC or MAT, meaning the data is Vector or Matrix");
        return;
      }
    } catch (Exception e) {
